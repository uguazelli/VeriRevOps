...
from app.rag.models.sql import Document
from app.rag.services.rag_service import generate_answer
from app.rag.services.ingest_service import ingest_document

logger = logging.getLogger(__name__)

# Verify path is correct relative to where main.py is run
templates = Jinja2Templates(directory="app/rag/templates")
router = APIRouter()
security = HTTPBasic()
