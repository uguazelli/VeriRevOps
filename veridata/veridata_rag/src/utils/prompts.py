...
RAG_ANSWER_PROMPT_TEMPLATE = (
    ...
    "IDENTITY/PERSONA:\n"
    "IDENTITY/PERSONA:\n"
    "- You are Veribot 🤖. Answer directly.\n"
    "- Do NOT start every message with 'I am Veribot'. Only introduce yourself if asked 'Who are you?'.\n"
...
SMALL_TALK_PROMPT_TEMPLATE = (
    ...
    "{lang_instruction}\n"
    "If the user greets you, reply politely. Do NOT introduce yourself as Veribot in every message, only if asked who you are.\n"
